...
namespace ReadingLog.Data.Migrations
{
    ...
    [Migration("20211206060646_AuthorUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReadingLog.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ReadingLog.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ReadingLog.Data.Author", b =>
                {
                    b.HasOne("ReadingLog.Data.ApplicationUser", "User")
                        .WithMany("Authors")
                        .HasForeignKey("UserId");
